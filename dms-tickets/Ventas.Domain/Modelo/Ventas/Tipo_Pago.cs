...
namespace Ventas.Domain.Modelo.Ventas
{
    public class Tipo_Pago : Entity<Guid>
    {
        ...
        internal Tipo_Pago(Guid _vueloId,  decimal _montoReserva, decimal _montoSubTotal, 
            decimal _montoTotal, int _cantidadTicket, decimal _precio, string _descripcion)
        {
            Id = Guid.NewGuid();
            VueloId = _vueloId;
            ...
            montoSubTotal = new PrecioValue(_precio - _montoReserva);
            montoTotal = new PrecioValue(_precio * _cantidadTicket);
        }

        internal void ModificarVenta(int _cantidadTicket, decimal _precio, decimal _montoReserva)
        {
            cantidadTicket = _cantidadTicket;
            precio = _precio;
            montoSubTotal = _precio - _montoReserva;
            montoTotal = _precio * _cantidadTicket;
        }
    }
}
